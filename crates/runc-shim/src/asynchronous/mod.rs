...
#[cfg(feature = "sandbox")]
use containerd_shim::protos::sandbox::{sandbox, sandbox_ttrpc::Sandbox};
use containerd_shim::{
    asynchronous::{
        container::Container,
    ...
    Config, Context, DeleteResponse, Error, StartOpts, TtrpcContext, TtrpcResult,
};
...
impl Sandbox for Service {
    async fn create_sandbox(
        &self,
        _ctx: &TtrpcContext,
        _req: sandbox::CreateSandboxRequest,
    ) -> TtrpcResult<sandbox::CreateSandboxResponse> {
        Ok(sandbox::CreateSandboxResponse::default())
    }

    async fn start_sandbox(
        &self,
        _ctx: &TtrpcContext,
        _req: sandbox::StartSandboxRequest,
    ) -> TtrpcResult<sandbox::StartSandboxResponse> {
        Ok(sandbox::StartSandboxResponse::default())
    }

    async fn platform(
        &self,
        _ctx: &TtrpcContext,
        _req: sandbox::PlatformRequest,
    ) -> TtrpcResult<sandbox::PlatformResponse> {
        Ok(sandbox::PlatformResponse::default())
    }

    async fn stop_sandbox(
        &self,
        _ctx: &TtrpcContext,
        _req: sandbox::StopSandboxRequest,
    ) -> TtrpcResult<sandbox::StopSandboxResponse> {
        Ok(sandbox::StopSandboxResponse::default())
    }

    async fn wait_sandbox(
        &self,
        _ctx: &TtrpcContext,
        _req: sandbox::WaitSandboxRequest,
    ) -> TtrpcResult<sandbox::WaitSandboxResponse> {
        Ok(sandbox::WaitSandboxResponse::default())
    }

    async fn sandbox_status(
        &self,
        _ctx: &TtrpcContext,
        _req: sandbox::SandboxStatusRequest,
    ) -> TtrpcResult<sandbox::SandboxStatusResponse> {
        Ok(sandbox::SandboxStatusResponse::default())
    }

    async fn ping_sandbox(
        &self,
        _ctx: &TtrpcContext,
        _req: sandbox::PingRequest,
    ) -> TtrpcResult<sandbox::PingResponse> {
        Ok(sandbox::PingResponse::default())
    }

    async fn shutdown_sandbox(
        &self,
        _ctx: &TtrpcContext,
        _req: sandbox::ShutdownSandboxRequest,
    ) -> TtrpcResult<sandbox::ShutdownSandboxResponse> {
        Ok(sandbox::ShutdownSandboxResponse::default())
    }
}
